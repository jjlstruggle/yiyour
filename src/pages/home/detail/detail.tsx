...
function Detail(){
   ...
   const Oups:React.FC=()=>{
    ...
    return(
        <div style={{width:"100vw",padding:"2vh 6vw"}}>
             ...
             <Divider />
             <div className="flex">
                  <Upload {...props}><Button  className="bg-slate-300" icon={<UploadOutlined />}>点击上传作品</Button></Upload>
                  <Button className="bg-main ml-10 text-xs text-zinc-50">确认提交</Button>
             </div>
   ...
   const Process:React.FC=()=>{
         return(
           ...
           <p className="text-xl">填写出价(大于等于发布者理想买价直接成交)-发布者接受或者拒绝出价-收到结果</p>
      </div>
         )
   }
   const Result:React.FC=()=>{
    return(
       <div className=" w-full h-3/5" style={{padding:"2vh 6vw",backgroundColor:"#F7F7F7"}}>
       <div className="text-xl font-bold flex items-center ">
          <div className="bg-main w-3 h-6 mr-2" ></div>
          发布推荐
       </div>
   ...
   return(
    <div className="flex flex-col ">
         <div style={{width:"100vw"}} className="flex justify-between  box-border my-14">
                <div className=" relative w-1/2">
                    <div className="absolute text-xl -top-8 left-1/4  flex">
                        /任务集市/文本文案
                    </div>
                    <img src={img1} className=" h-1/2.5" style={{
                ...
                <div className="flex flex-col ml-20 justify-around w-1/2 ">
                    ...
                    <Button  className="w-52 h-10 bg-main text-amber-50 font-semibold" >我要提交</Button>
                    <Button className="w-52 h-10 bg-yellow-500 font-semibold">添加收藏</Button>
                </div>
         </div>
         <Demand />
         <Have />
